    ...
    <>
      ...
      <div className="skills-container">
        <div className="skills-project">
          ...
          <div className="skills-description">
            I mainly utilize <strong>React.js/Next.js/T3</strong> for developing websites applications and some libraries like <strong>Tailwind</strong>. For web design I like to use <strong>Figma</strong>.
          </div>
        </div>
        <div className="skills-project">
          ...
          <div className="skills-description">
            For building the backend I utilize <strong>Python</strong> with <strong>Flask</strong> or <strong>Django</strong>. I'm proficient as well in <strong>Node.js</strong> with <strong>Express.js</strong>. And recently I've been using <strong>Next.js</strong> with the T3 Stack.
          </div>
        </div>
        <div className="skills-project">
          ...
          <div className="skills-description">
            My favorite DB manager is <strong>PostgreSQL</strong> for working with relational data, and I'm also experiencied with <strong>SQLite</strong> and <strong>MySQL</strong>.
          </div>
        </div>
        <div className="skills-project">
          ...
          <div className="skills-description">
            For developing and production I employ <strong>Git</strong>, <strong>CI/CD</strong>, <strong>Nginx</strong>, <strong>Docker</strong>, <strong>Vercel/AWS/GCP/Azure</strong> and <strong>Kubernetes</strong>.
          </div>
        </div>
        <div className="skills-project">
